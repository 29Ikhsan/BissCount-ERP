...
export default function DeveloperPlatform() {
  const [apiKeys] = useState([
    { name: 'POS Integration', key: 'sk_live_51Pq...j8x9', created: '2024-03-24', status: 'Active' },
    { name: 'Marketplace Sync', key: 'sk_live_12x...k3a2', created: '2024-03-20', status: 'Active' },
  ]);
    ...
    <div className={styles.container}>
      ...
      <div className={styles.card}>
        ...
        <div className={styles.apiKeyList}>
          {apiKeys.map((key) => (
            <div key={key.name} className={styles.apiKeyItem}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
                ...
                <button title="Copy to clipboard" style={{ background: 'none', border: 'none', cursor: 'pointer', color: '#64748B' }}>
                  <Copy size={16} />
                </button>
                <button title="Revoke Key" style={{ background: 'none', border: 'none', cursor: 'pointer', color: '#EF4444' }}>
                  <Trash2 size={16} />
                </button>
              </div>
            </div>
